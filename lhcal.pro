pro lhcal, fname, xr = xr, yr = yr, nods = nods, nolines = nolines, ps = ps, notrim = notrim, no_offset = no_offset
...
if keyword_set(ps) then begin
	set_plot,'ps'
	device, /landscape, $
		filename = plotdir+strjoin(strsplit(obj,' ',/extract))+'_spect_lh.ps'
...
; Use the spectroscopic redshifts of the objects (from NED) to plot images in the target rest frame
	...
	readcol, cofiles(0), sh_order, sh_wave, sh_flux, sh_err, sh_bit, format = 'i,f,f,f,i', /silent
	readcol, nodfiles(0), sh_1p_order, sh_1p_wave, sh_1p_flux, sh_1p_err, sh_1p_bit, format = 'i,f,f,f,i', /silent
	readcol, nodfiles(1), sh_2p_order, sh_2p_wave, sh_2p_flux, sh_2p_err, sh_2p_bit, format = 'i,f,f,f,i', /silent
