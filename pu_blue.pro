...
; List of OHMs with spectra using offset peakups
...
filelist=['~/Astronomy/Research/Spitzer/OHM/data/mega0??_spectra/ch0/bcd/*_000[0,1]_000[0,1,2,3]_*bcd.fits']
...
for k = 0, n_elements(files) - 1 do begin
	temptag = strmid(files(k), 52, 7)
	tempindex = where(temptag eq ohm_offset)
...
dir_out='~/Astronomy/Research/Spitzer/OHM/pu_blue/'
fitsdir_out='~/Astronomy/Research/Spitzer/OHM/pu_blue/fits/'
phot_file='~/Astronomy/Research/Spitzer/OHM/pu_blue/pu_blue_phot.txt'
centroid_file='~/Astronomy/Research/Spitzer/OHM/pu_blue/pu_blue_cntrds.txt'
...
; Log the day of observations
	...
	nameout=progid+'_'+STRMID(object,0,18)+'_'+STRTRIM(filter,2)+'_'+STRMID(newfiles(i), 52, 7)
