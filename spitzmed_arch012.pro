pro spitzmed_arch012, shsky=shsky, lhsky = lhsky, ss = ss, modules = modules, lores = lores
;+
; NAME:
;       SPITZMED_ARCH012
;
...
;	and sky subtract. This is designed for object arch012, which has no peakup on the target.
;
; INPUTS:
;
...
for m=0,1 do begin
	...
	if keyword_set(lhsky) then begin
		...
		skypath = '~/Astronomy/Research/Spitzer/'+dirtag+'/data/'+specname+'_bkgrd/ch3/'+filetype+'/'
		...
		if lhsky_size[0] eq 2 then begin
	...
	writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch3_sub_medarr_1p_'+filetype+'.fits', sub_medarr_lh_1p, hdr_lh_1p
	writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch3_sub_medarr_2p_'+filetype+'.fits', sub_medarr_lh_2p, hdr_lh_2p
	...
	if keyword_set(shsky) then begin
		...
		skypath = '~/Astronomy/Research/Spitzer/'+dirtag+'/data/'+specname+'_bkgrd/ch1/'+filetype+'/'
	...
	writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch1_medarr_1p_'+filetype+'.fits', sub_medarr_sh_1p, hdr_sh_1p
	writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch1_medarr_2p_'+filetype+'.fits', sub_medarr_sh_2p, hdr_sh_2p
	...
	if keyword_set(ss) then begin
		...
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch2_sub_medarr_2o_1p_'+filetype+'.fits', sub_medarr_ll2_1p, hdr_ll2_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch2_sub_medarr_2o_2p_'+filetype+'.fits', sub_medarr_ll2_2p, hdr_ll2_2p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch2_sub_medarr_1o_1p_'+filetype+'.fits', sub_medarr_ll1_1p, hdr_ll1_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch2_sub_medarr_1o_2p_'+filetype+'.fits', sub_medarr_ll1_2p, hdr_ll1_2p
		...
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch2_sub_medarr_2o_1p_'+filetype+'.fits', sub_medarr_ll2_1p, hdr_ll2_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch2_sub_medarr_2o_2p_'+filetype+'.fits', sub_medarr_ll2_2p, hdr_ll2_2p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch2_sub_medarr_1o_1p_'+filetype+'.fits', sub_medarr_ll1_1p, hdr_ll1_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch2_sub_medarr_1o_2p_'+filetype+'.fits', sub_medarr_ll1_2p, hdr_ll1_2p
	...
	if keyword_set(ss) then begin
		...
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch0_sub_medarr_2o_1p_'+filetype+'.fits', sub_medarr_sl2_1p, hdr_sl2_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch0_sub_medarr_2o_2p_'+filetype+'.fits', sub_medarr_sl2_2p, hdr_sl2_2p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch0_sub_medarr_1o_1p_'+filetype+'.fits', sub_medarr_sl1_1p, hdr_sl1_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/ss/'+specname+'_ch0_sub_medarr_1o_2p_'+filetype+'.fits', sub_medarr_sl1_2p, hdr_sl1_2p
		...
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch0_sub_medarr_2o_1p_'+filetype+'.fits', sub_medarr_sl2_1p, hdr_sl2_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch0_sub_medarr_2o_2p_'+filetype+'.fits', sub_medarr_sl2_2p, hdr_sl2_2p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch0_sub_medarr_1o_1p_'+filetype+'.fits', sub_medarr_sl1_1p, hdr_sl1_1p
		writefits,'~/Astronomy/Research/Spitzer/spitzmed/'+specname+'_ch0_sub_medarr_1o_2p_'+filetype+'.fits', sub_medarr_sl1_2p, hdr_sl1_2p
...
print,'SPITZMED_ARCH012 completed for ',specname
