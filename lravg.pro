...
allspec = fltarr(n_elements(grid),nf)
...
;	xtickv = [5,6,7,8,9,10,12,14,16,18,20,25,30], $
	...
	xtitle = 'Wavelength (rest frame) [!7l!3m]', $
	ytitle = 'Flux density', $
	title = 'Non-masing control sample', $
	thick = lthick, charthick = cthick, charsize = cs
...
oplot,newx,meancon,color=fsc_color("Blue"),thick=2
...
meanarch = median(archspec,dim=2)
oplot,newx,meanarch,color=fsc_color("Green"),thick=2
