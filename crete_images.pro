...
; PURPOSE:
;
;	Make poster-quality images for Crete IR conference
;
; INPUTS:
;
;	
...
!p.multi=[0,1,1]
	...
	set_plot,'ps'
	device,filename='~/Astronomy/Research/Spitzer/crete_conference/specavg.ps', /color, /portrait, xs=18, ys=12
	cs = 1.8
	lthick = 7
	cthick = 7
	medthick = 5
...
conloh = float([transpose(cloh[0,*])])
	...
	set_plot,'ps'
	device,filename='~/Astronomy/Research/Spitzer/crete_conference/sil_a3020.ps', /color, /portrait, xs=15, ys=12
	thick = 7
	cthick = 7
	symthick = 4
	csize = 2
...
oplot, consil, conspindex, psym = symcat(7), thick=thick, color=defcolor
...
; Begin plotting
	...
	set_plot,'ps'
	device,filename='~/Astronomy/Research/Spitzer/crete_conference/spoon_forkII.ps', /color, /portrait
	cs = 2.0
	ls = 7
...
!p.multi = [0,1,1]
	...
	set_plot,'ps'
	device,filename='~/Astronomy/Research/Spitzer/crete_conference/feature2_ohm.ps',/color,/portrait
	defcolor = fsc_color("Black")
	cs = 2.0
	lthick = 7
	cthick = 7
...
!p.multi=[0,1,2]
	...
	set_plot,'ps'
	device, filename='~/Astronomy/Research/Spitzer/crete_conference/lockettplot.ps', /portrait, /color, xs=14, ys=26, xoff=0, yoff=0
	defcolor=fsc_color("Black")
	cs = 1.5
	barcs = 1.0
	th = 4
