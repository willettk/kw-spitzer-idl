pro spiceprep_arch012, ss = ss, modules = modules, lores = lores
;+
; NAME:
;       SPICEPREP_ARCH012
;
...
;	batch processing in SPICE; designed for arch012, which does not peak up on anything
;
; INPUTS:
;
...
print,'SPICEPREP_ARCH012 completed for ',specname
