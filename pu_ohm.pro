...
;
; PURPOSE:
; 	Read Spitzer SUR peakup images and perform photometry on PBCD mosaicked images in OHM sample. 
;
; CATEGORY:
...
;
;	Adapted from PU_READ.pro - KW, Aug 07
;-

; Program is run twice - once for blue and once for red peakups

filelist=['~/Astronomy/Research/Spitzer/OHM/data/mega0??_peakup/ch0/pbcd/*b_mos.fits', $
	'~/Astronomy/Research/Spitzer/OHM/data/mega0??_peakup/ch0/pbcd/*r_mos.fits']
filterlist = ['Blue','Red']

dir_out='~/Astronomy/Research/Spitzer/OHM/pu_ohm/'
phot_file='~/Astronomy/Research/Spitzer/OHM/pu_ohm/pu_phot.txt'
...
; Photometry of ACQ image
    ...
    save, file='~/Astronomy/Research/Spitzer/ohm/data/idl_sav/pu_sur_ohm.sav', $
